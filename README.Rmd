...
## Performance vs Position Played
  ...
  Alright, back to Wayne Gretzky.  We just saw that he was a center. How many skaters from different positions are we comparing against?  There are the offensive players (center, left wing, and right wing) We wouldn't want to compare that position against a defenseman for scoring. Let's generate average penalty time per game and and average goals per game to see how the different positions compare.

...
getTeamStats<- function(aExpand="", aSeason = "", aTeams = "", aName = "", aTeamID= "", aFranchiseID = ""){

  #Process our inputs.  If any is non-empty, we need to add a query modifier.
#Need to pull for TeamID
fTeamStr = ""
if(aName!="" | aTeamID != "" | aFranchiseID !="") fTeamStr <- pullIDDecoder(aName, aTeamID, aFranchiseID)$TeamID
#Append the appropriate prefix for this base & endpoint
if(fTeamStr != "") fTeamStr <-paste0("/",fTeamStr$TeamID)
...
gdfTeamStatse<- getTeamStats(aExpand = "Teamslist", aTeams = "4,5,7")
gdfTeamStatsf<- getTeamStats(aSeason = "20142015")
gdfTeamStatsg<- getTeamStats(aExpand = "", aSeason = "")
gdfTeamStatsh<- getTeamStats()
gdfTeamStatsi<- getTeamStats()
gdfTeamStatsj<- getTeamStats()
gdfTeamStatsk<- getTeamStats(aTeamID = "2", aTeams = "4,5,7")
